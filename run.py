...
# Compute real_rate from emission distribution (exponential scale = mean inter-arrival time)
...
geom_rate = GEOM(real_rate, emission_angle=params['gen_alpha'], emission_radius=params['gen_radius'], sensor_x_dimension=np.array(params['sen_dimensions']), sensor_x_position=params['sen_pos'][0])
